      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-20 lg:pt-28 pb-10 lg:pb-16">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              {[
                { href: 'https://github.com/Gustavo16378', label: 'GitHub', icon: <SiGithub size={16} /> },
                { href: 'https://linkedin.com/in/gustavo-barbosa-lima-341886278', label: 'LinkedIn', icon: <Linkedin size={16} /> },
                {
                  href: 'https://instagram.com/gustavoDev',
                  label: 'Instagram',
                  icon: (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 pointer-events-none" style={{
                      background: `
                        ...
                        linear-gradient(to left,   rgba(2,2,13,0.82) 0%, transparent 32%)
                      `
                    }} />
                  </motion.div>
                </AnimatePresence>
